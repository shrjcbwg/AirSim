...
public:
    ...
    string pub_vel;
    string cmd_output_filename;
    string odo_output_filename;
    PIDParams():
        kp_x(0.5),
        kp_y(0.5),
        kp_z(0.5),
...
public:
    ...
    DynamicConstraints():
        max_vel_horz_abs(3.0),
        max_vel_vert_abs(3.0),
        max_yaw_rate_degree(45.0)
        {}
...
public:
    ...
    // void home_geopoint_cb(const sensor_msgs::NavSatFix& gps_msg);
...
private:
    ...
    XYZYaw target_position_temp;

    XYZYaw pos_error_;
    XYZYaw vel_error_;
    
    Eigen::Vector3d target_position, target_velocity, target_velocity_temp, target_acceleration, target_acceleration_temp, pos_error, vel_error, curr_position, curr_velocity, curr_acceleration;
    Eigen::Vector3d kx, kv;
    double target_yaw, target_yaw_dot;
    ...
    // sensor_msgs::NavSatFix gps_home_msg_;
    quadrotor_msgs::PositionCommand pos_cmd_msg_;
